...
{
    SerializedProperty hand, leftHolster, rightHolster, leftGrip_Input, rightGrip_Input, left_CanGrab, right_CanGrab, leftCarrying, rightCarrying, leftEnter, rightEnter, leftObj, rightObj, leftObjTag, rightObjTag;
